...
void menu::render() {
	...
	menu_framework::group_box(variables::menu::x + 5, variables::menu::y + 35, 290, 85, render::fonts::watermark_font, "Visuals", false); {
		...
		menu_framework::check_box(variables::menu::x + 15, variables::menu::y + 100, variables::menu::x + 275, render::fonts::watermark_font, "Display stats?", variables::draw_stats_bool);
	}

	menu_framework::group_box(variables::menu::x + 5, variables::menu::y + 125, 290, 60, render::fonts::watermark_font, "Misc", false); {
		menu_framework::check_box(variables::menu::x + 15, variables::menu::y + 135, variables::menu::x + 275, render::fonts::watermark_font, "Bhop", variables::bhop_bool);
		menu_framework::check_box(variables::menu::x + 15, variables::menu::y + 150, variables::menu::x + 275, render::fonts::watermark_font, "Custom crosshair", variables::crosshair_bool);
		menu_framework::check_box(variables::menu::x + 15, variables::menu::y + 165, variables::menu::x + 275, render::fonts::watermark_font, "Spectator list", variables::spectator_list_bool);
	}
