...
ImGuiStyle::ImGuiStyle() {
	...
	Colors[ImGuiCol_PopupBg] = ImVec4(0.09f, 0.09f, 0.09f, 0.90f);
	...
	Colors[ImGuiCol_CheckboxActive] = ImVec4(244 / 255.f, 202 / 255.f, 22 / 255.f, 1);
}
...
bool ImGui::Checkbox(const char* label, bool* v) {
	...
	{
		col_bg = ImGui::GetColorU32(ImLerp(ImVec4(0.00f, 0.00f, 0.00f, 1.0f), ImVec4(211 / 255.f, 151 / 255.f, 0 / 255.f, 1.0f), t));
		checkbg = ImGui::GetColorU32(ImLerp(ImVec4(1.00f, 1.00f, 1.00f, 1.0f), ImVec4(1.00f, 1.00f, 1.00f, 1.0f), t));
	}
	...
	draw_list->AddCircleFilled(ImVec2(p.x + radius + t * (width - radius * 2.0f), p.y + radius), radius - 1.5f, checkbg);
