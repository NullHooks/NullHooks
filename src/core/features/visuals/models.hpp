...
namespace models {
	...
	/*   Weapon id                           Viewmodel, Worldmodel, Dropped worldmodel */
		...
		{ WEAPON_AK47,						{ "models/weapons/eminem/ethereal/v_ethereal.mdl", "models/weapons/eminem/ethereal/w_ethereal.mdl", "models/weapons/eminem/ethereal/w_ethereal_dropped.mdl" } },
		{ WEAPON_AUG,						{ NULL, NULL, NULL } },
		{ WEAPON_AWP,						{ "models/weapons/eminem/dsr_50/v_dsr_50_2.mdl", "models/weapons/eminem/dsr_50/w_dsr_50_2.mdl", "models/weapons/eminem/dsr_50/w_dsr_50_dropped.mdl" } },
		...
		{ WEAPON_KNIFE,						{ "models/weapons/caleon1/screwdriver/v_knife_screwdriver.mdl", NULL, NULL } },
