...
#define sig_glow_manager		"0F 11 05 ? ? ? ? 83 C8 01"
#define sig_player_move_helper	"8B 0D ? ? ? ? 8B 45 ? 51 8B D4 89 02 8B 01"
...
#define sig_fire_event							"55 8B EC 83 E4 F8 83 EC 0C 8B C1"
#define sig_view_render							"8B 0D ? ? ? ? D9 5D F0 8B 01"
